...
git push -> Envia o arquivo pro repositório
*/
...
git switch <branch>(main) -> Navega pra branch querida
...
// git config --global alias.hist 'log --pretty=format:"%h %ad | %s%d[%an]" --graph --date=short' -> comando para ficar mais fa´cil a visualização
